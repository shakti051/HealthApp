...
public class Upload_bill_Adapter extends RecyclerView.Adapter<Upload_bill_Adapter.ViewHolder> {
    ...
    private String date[] = {"26/05/2018", "27/05/2018", "30/05/2018"};

    public Upload_bill_Adapter(Context context, ArrayList<String> data) {
    ...
    public Upload_bill_Adapter(Context context, String data) {
        this.context = context;
        this.data = data;
        onClickListerner_adapte = (OnClickListerner_Adapter) context;
...
//    }
    ...
    @Override
    public Upload_bill_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.single_row_consult_history, parent, false);
        return new Upload_bill_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Upload_bill_Adapter.ViewHolder holder, final int position) {
//        holder.patientNameTV.setText(doc_appoinList.get(position));
        ...
        holder.profileIV.setImageResource(images_array[position]);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView patientnameTV, dateTV, emergencyCall_TV, symptomTV, appointDateTV;
