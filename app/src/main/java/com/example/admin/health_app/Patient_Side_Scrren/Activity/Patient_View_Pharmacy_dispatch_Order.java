...
public class Patient_View_Pharmacy_dispatch_Order extends AppCompatActivity {
    ...
    private void setIds() {
        ...
        dispatch_pharmacy_orderRV.setAdapter(new Patient_View_Dispatch_Pharmacy_Order_Adapter(this,"1"));
    }
    @Override
