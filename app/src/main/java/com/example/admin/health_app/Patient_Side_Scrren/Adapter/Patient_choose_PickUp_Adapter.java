...
public class Patient_choose_PickUp_Adapter extends RecyclerView.Adapter<Patient_choose_PickUp_Adapter.ViewHolder> {
    private Context context;
    private ArrayList<String> doc_appoinList;

    private String number[] = {"Telmekind AM Tab", "Crocin 100mg Tab"};
    private String day[] = {"Once a Day 5 days", "Once a Day 10 days"};

    public Patient_choose_PickUp_Adapter(Context context, ArrayList<String> data) {
        this.context = context;
        doc_appoinList = data;
        Log.e("data_adpater11111", "view_Seller" + data);
    }

    public Patient_choose_PickUp_Adapter(Context context, String data) {
        this.context = context;
        data = data;
...
//    }
    ...
    @Override
    public Patient_choose_PickUp_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.single_row_pick_up_or_self, parent, false);
        return new Patient_choose_PickUp_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Patient_choose_PickUp_Adapter.ViewHolder holder, final int position) {
