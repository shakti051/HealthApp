...
public class Patient_View_Pathology_Order extends AppCompatActivity {
    ...
    private void setIds() {
        ...
        toolbarTitleText.setText("Pathology Order");
        ...
        view_pathologyOrder_TV.setAdapter(new View_Pathology_List_Order(this,"Apollo Pharmacy"));
