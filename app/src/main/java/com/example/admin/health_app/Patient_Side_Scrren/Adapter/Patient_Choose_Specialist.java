...
public class Patient_Choose_Specialist extends RecyclerView.Adapter<Patient_Choose_Specialist.ViewHolder> {
    private Context context;
    private ArrayList<String> doc_appoinList;
    private String[]name={"Dr.Satish","Dr.Gaurav Sharma"};
    private int[]images={R.drawable.doctor, R.drawable.boy_doctor};
    private OnclickListner_Adapter onclickListner_adapter;
    public Patient_Choose_Specialist(Context context, ArrayList<String> data) {
        this.context = context;
        doc_appoinList = data;
        Log.e("data_adpater11111", "view_Seller" + data);
    }

    public Patient_Choose_Specialist(Context context, String data) {
        this.context = context;
        data = data;
...
//    }
    ...
    @Override
    public Patient_Choose_Specialist.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.single_row_choose_pathology, parent, false);
        return new Patient_Choose_Specialist.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Patient_Choose_Specialist.ViewHolder holder, final int position) {
