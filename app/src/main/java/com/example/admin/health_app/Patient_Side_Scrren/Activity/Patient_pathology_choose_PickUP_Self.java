...
public class Patient_pathology_choose_PickUP_Self extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    private void setIds() {
        ...
        submitBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Patient_pathology_choose_PickUP_Self.this,Current_Conulation.class));
            }
        });
        ...
        radioGroupPick.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (homeDeliveryRadio.getText().toString().equals("Home Collect")) {
                    homeDeliveryRadio.setTextColor(Color.BLACK);
                    homeDelievryLY.setVisibility(View.VISIBLE);
                    Log.e("andar_aaya", "");
                } else if (homeDeliveryRadio.getText().toString().equals("Lab Sample")) {
