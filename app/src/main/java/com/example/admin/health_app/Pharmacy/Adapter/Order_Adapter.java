...
public class Order_Adapter extends RecyclerView.Adapter<Order_Adapter.ViewHolder> {
    ...
    public Order_Adapter(Context context, ArrayList<String> data) {
    ...
    public Order_Adapter(Context context, String data) {
        this.context = context;
        this.data = data;
        onClickListerner_adapte = (OnClickListerner_Adapter) context;
...
//    }
    ...
    public Order_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new Order_Adapter.ViewHolder(itemView);
    }
...
holder.cancelBTN.setOnClickListener(new View.OnClickListener() {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView patientnameTV, dateTV, cancelBTN, symptomTV, appointDateTV;
