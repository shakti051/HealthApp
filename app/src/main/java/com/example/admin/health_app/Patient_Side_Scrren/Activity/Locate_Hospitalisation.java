...
import com.example.admin.health_app.Patient_Side_Scrren.Adapter.Patient_choose_Hospital_pick_adapter;
...
public class Locate_Hospitalisation extends AppCompatActivity implements Patient_choose_Hospital_pick_adapter.OnclickListner_Adapter {
    ...
    private void setIds() {
        ...
        toolbarTitleText.setText("Choose Hospitalisation");
        ...
        recycleviewRV.setAdapter(new Patient_choose_Hospital_pick_adapter(this,"1"));
...
//        finish();
    ...
    public void onClick(int position) {
        ...
        startActivity(new Intent(this,Patient_Hospital_Connect_Concierge.class));
    }
