...
import com.example.admin.health_app.Pathology.Activity.Pathology_Confirm_Order;
...
public class Pathology_Order_Adapter extends RecyclerView.Adapter<Pathology_Order_Adapter.ViewHolder> {
    private Context context;
    private String data;
    OnClickListerner_Adapter onClickListerner_adapte;
    private ArrayList<String> doc_appoinList;

    public Pathology_Order_Adapter(Context context, ArrayList<String> data) {
        this.context = context;
        doc_appoinList = data;
        Log.e("data_adpater11111", "view_Seller" + data);
    }

    public Pathology_Order_Adapter(Context context, String data) {
        this.context = context;
        data = data;
...
//    }
    ...
    @Override
    public Pathology_Order_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.single_row_pathology_order, parent, false);
        return new Pathology_Order_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Pathology_Order_Adapter.ViewHolder holder, final int position) {
        ...
        holder.confirmBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                context. startActivity(new Intent(context,Pathology_Confirm_Order.class));
            }
        });
