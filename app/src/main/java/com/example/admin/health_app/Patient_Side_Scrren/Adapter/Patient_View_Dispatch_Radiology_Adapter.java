...
public class Patient_View_Dispatch_Radiology_Adapter extends RecyclerView.Adapter<Patient_View_Dispatch_Radiology_Adapter.ViewHolder> {
    private Context context;
    private ArrayList<String> doc_appoinList;

    private String number[] = {"UltraSound Test", "X-ray"};

    public Patient_View_Dispatch_Radiology_Adapter(Context context, ArrayList<String> data) {
        this.context = context;
        doc_appoinList = data;
        Log.e("data_adpater11111", "view_Seller" + data);
    }

    public Patient_View_Dispatch_Radiology_Adapter(Context context, String data) {
        this.context = context;
        data = data;
...
//    }
    ...
    @Override
    public Patient_View_Dispatch_Radiology_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.single_row_patient_view_disptach_order, parent, false);
        return new Patient_View_Dispatch_Radiology_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Patient_View_Dispatch_Radiology_Adapter.ViewHolder holder, final int position) {
